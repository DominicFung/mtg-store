(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_box_page_tsx_bf5be405._.js", {
...
function ImageCropper({ imageSrc }) {
    ...
    const [boxes, setBoxes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Array.from({
        length: BOX_COUNT
    }, {
        "ImageCropper.useState": (_, i)=>({
                x: i * 120,
                y: 50,
                width: 120,
                height: 120 / ASPECT_RATIO
            })
    }["ImageCropper.useState"]));
...
_s(ImageCropper, "c+imuTmT+9GdRHyAfbvzo3Dy+Xo=");
_c = ImageCropper;
var _c;
...
//# sourceMappingURL=app_box_page_tsx_bf5be405._.js.map